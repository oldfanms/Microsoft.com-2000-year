...
if (ToolBar_Supported != null && ToolBar_Supported == true)
{
	...
	addMSSubMenu("ProductsMenu","BackOffice Family","/isapi/gomscom.asp?target=/backoffice/");
	...
	addMSSubMenu("ProductsMenu","Windows Family","/windows/");
	addMSSubMenu("ProductsMenu","MSN","https://web.archive.org/web/20000301151106/http://www.msn.com/");

	//SupportMenu
	addMSMenu("SupportMenu", "Support", "","/isapi/gomscom.asp?target=/support/");
	addMSSubMenu("SupportMenu","Knowledge Base","https://web.archive.org/web/20000301151106/http://support.microsoft.com/search/");
	addMSSubMenu("SupportMenu","Product Support Options","/isapi/gomscom.asp?target=/support/");
	addMSSubMenu("SupportMenu","Service Partner Referrals","/isapi/gomscom.asp?target=/biz/provider/default.asp");
	addMSSubMenu("SupportMenu","Year 2000 Compliance","/isapi/gomscom.asp?target=/technet/year2K/");
	...
	addMSSubMenu("SearchMenu","MSN Web Search","https://web.archive.org/web/20000301151106/http://search.msn.com/");
	...
	addMSSubMenu("MicrosoftMenu","MSN Home","https://web.archive.org/web/20000301151106/http://www.msn.com/");
	addMSSubMenuLine("MicrosoftMenu");
	addMSSubMenu("MicrosoftMenu","Contact Us","/isapi/goregwiz.asp?target=/regwiz/forms/contactus.asp");
	addMSSubMenu("MicrosoftMenu","Events","https://web.archive.org/web/20000301151106/http://events.microsoft.com/events/");
	...
	addMSSubMenu("MicrosoftMenu","Free E-mail Account","https://web.archive.org/web/20000301151106/http://www.hotmail.com/");
}
